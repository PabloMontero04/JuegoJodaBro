...
public class main extends JFrame {
    ...
    public main() {
        ...
        // Crear una instancia de Enemy
        enemy = new Enemy(944, 475, "src/img/vader.gif");
        ...
        platforms.add(new Platform(600, 388, 111, 22, "src/img/suelo.png"));
        platforms.add(new Platform(1233, 388, 83, 22, "src/img/suelo.png"));
        platforms.add(new Platform(2000, 388, 203, 22, "src/img/suelo.png"));
        platforms.add(new Platform(2200, 388, 203, 22, "src/img/suelo.png"));
        
        //Monedas
        coins = new ArrayList<>();
        coins.add(new Coin(335, 350, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(375, 350, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(640, 350, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(1050, 388, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(1250, 350, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(1280, 350, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(2000, 420, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(2050, 420, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(2100, 420, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(2150, 420, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(2200, 420, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(2250, 420, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(2300, 420, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(2350, 420, 30, 30, "src/img/moneda.gif"));
        coins.add(new Coin(2400, 420, 30, 30, "src/img/moneda.gif"));
        ...
        Timer timer = new Timer(10, (e) -> {
            ...
            if (enemy.collidesWithPlayer(characterX, characterY, characterWidth, characterWidth)) {
                // Acciones cuando hay colisión con el enemigo (por ejemplo, decrementar vidas y reiniciar posición)
                lives--;
                if (lives <= 0) {
